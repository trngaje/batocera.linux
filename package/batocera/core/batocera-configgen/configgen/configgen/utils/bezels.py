...
def getBezelInfos(rom, bezel, systemName, emulator):
    ...
    search_paths = [
        ...
        ( f"{batoceraFiles.overlayUser}/{bezel}/games/{systemName}/{romBase}-{resolution}", True),
        ( f"{batoceraFiles.overlayUser}/{bezel}/games/{systemName}/{romBase}", True),
        ( f"{batoceraFiles.overlaySystem}/{bezel}/games/{systemName}/{romBase}-{resolution}", True),
        ( f"{batoceraFiles.overlaySystem}/{bezel}/games/{systemName}/{romBase}", True),
        ...
        ( f"{batoceraFiles.overlayUser}/{bezel}/systems/{systemName}-{resolution}", False) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlaySystem}/{bezel}/systems/{systemName}-{resolution}", False) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlayUser}/{bezel}/default-{resolution}", True) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlaySystem}/{bezel}/default-{resolution}", True) if altDecoration != "90" and altDecoration != "270" else None,        
        ( f"{batoceraFiles.overlayUser}/{bezel}/systems/{systemName}", False) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlaySystem}/{bezel}/systems/{systemName}", False) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlayUser}/{bezel}/default", True) if altDecoration != "90" and altDecoration != "270" else None,
        ( f"{batoceraFiles.overlaySystem}/{bezel}/default", True) if altDecoration != "90" and altDecoration != "270" else None
    ]
